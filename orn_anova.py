...
import utils as utl                                  # already written
...
# --- top of file -----------------------------------------------------------
from constants import CELL_LOOKUP, CELL_LOOKUP_REV   # keep both
...
def run_anova(df: pd.DataFrame) -> None:
    ...
    anova = sm.stats.anova_lm(model, typ=3)           # Type II; Type III also ok
